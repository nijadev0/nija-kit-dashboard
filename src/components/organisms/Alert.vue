                        ...
                        <DialogPanel class="alert_card">
                            ...
                            <div class="alert_cta">
                                <div class="alert_cta-default">
                                    <Button @click="closeModal" variant="default" size="lg" class="w-full text-netral-50">Cancel</Button>
                                </div>
                                <div class="alert_cta-error">
                                    <Button variant="error" type="background" size="md" class="w-full">Delete</Button>
                                </div>
                            </div>
                        </DialogPanel>
                    </TransitionChild>
